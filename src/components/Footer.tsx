      ...
      <div className="max-w-7xl mx-auto py-12 px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-500 hover:text-nitter-blue transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/join" className="text-gray-600 hover:text-nitter-blue transition-colors duration-300">Join Us</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:nitterclub@nitt.edu" className="text-gray-600 hover:text-nitter-blue transition-colors duration-300">
                  nitterclub@nitt.edu
                </a>
              </li>
              <li className="flex items-center">
                <Phone className="w-5 h-5 text-nitter-blue mr-2 flex-shrink-0" />
                <a href="tel:+919876543210" className="text-gray-600 hover:text-nitter-blue transition-colors duration-300">
                  +91 98765 43210
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-200 pt-8 mt-8 text-center">
          <p className="text-gray-500 text-sm">
            &copy; {currentYear} NITTER R&D Club. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
